...
export const calendarEvents = [
  ...
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 0, 24, 10, 0),
    end: new Date(2025, 0, 24, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 0, 25, 8, 0),
    end: new Date(2025, 0, 25, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 0, 25, 9, 0),
    end: new Date(2025, 0, 25, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 0, 25, 11, 0),
    end: new Date(2025, 0, 25, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 0, 25, 13, 0),
    end: new Date(2025, 0, 25, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 0, 25, 14, 0),
    end: new Date(2025, 0, 25, 14, 45),
  },
];
